// /src/modules/funciones/FDatoCrudoDatalogerM11.js
...
const logger = require('log4js').getLogger('FDatoCrudoDatalogerM11');

class FDatoCrudoDatalogerM11 {
    static InsertarDatosM11(objDatoCrudoDL) {
        let respuesta = false;
        const query = "INSERT INTO datosdataloger.datocrudodatalogerm11(datocruddatam11_id, esta_id, varidata_id, sens_id, datocruddatam11_fecha, datocruddatam11_hora, datocruddatam11_nombrearchivo, datocruddatam11_valor,datocruddatam11_status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);";
    ...
    static verificarDatoCrudoServidorByID(cod) {
        ...
        const sql = "SELECT * FROM datosdataloger.fndatocrudodatosdatalogerm11byid(?);";
...
module.exports = FDatoCrudoDatalogerM11;
