// /src/modules/funciones/FDatoCrudoDatalogerM2.js
...
const logger = require('log4js').getLogger('FDatoCrudoDatalogerM2');

class FDatoCrudoDatalogerM2 {
    static InsertarDatosM2(objDatoCrudoDL) {
        let respuesta = false;
        const query = "INSERT INTO datosdataloger.datocrudodatalogerm2(datocruddatam2_id, esta_id, varidata_id, sens_id, datocruddatam2_fecha, datocruddatam2_hora, datocruddatam2_nombrearchivo, datocruddatam2_valor,datocruddatam2_status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);";
    ...
    static verificarDatoCrudoServidorByID(cod) {
        ...
        const sql = "SELECT * FROM datosdataloger.fndatocrudodatosdatalogerm2byid(?);";
...
module.exports = FDatoCrudoDatalogerM2;
