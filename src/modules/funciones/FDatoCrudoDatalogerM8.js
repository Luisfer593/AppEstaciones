// /src/modules/funciones/FDatoCrudoDatalogerM8.js
...
const logger = require('log4js').getLogger('FDatoCrudoDatalogerM8');

class FDatoCrudoDatalogerM8 {
    static InsertarDatosM8(objDatoCrudoDL) {
        let respuesta = false;
        const query = "INSERT INTO datosdataloger.datocrudodatalogerm8(datocruddatam8_id, esta_id, varidata_id, sens_id, datocruddatam8_fecha, datocruddatam8_hora, datocruddatam8_nombrearchivo, datocruddatam8_valor,datocruddatam8_status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);";
    ...
    static verificarDatoCrudoServidorByID(cod) {
        ...
        const sql = "SELECT * FROM datosdataloger.fndatocrudodatosdatalogerm8byid(?);";
...
module.exports = FDatoCrudoDatalogerM8;
